...
public:
	...
	static stringT GetMD5(BYTE* pBuf, UINT nLength, bool bHex = true);
	static stringT GetMD5(FILE* f, bool bHex = true);
	static stringT GetMD5( LPCTSTR lpszFilePath, bool bHex = true);
